...
function Home() {
    ...
    const addData = async () =>{
         await addDoc(usersCollectionRef, {category: category, description : discription,item_name: item_name , qantity: quantity })
...
<div className="mx-20">
<h3 className="text-lg font-medium leading-6 text-gray-900 mt-10 " style={{textAlign:"center"}}>
               ADD NEW ITEM
              </h3>
  ...
  <tbody>
  {
      ...
      <td className="w-full lg:w-auto p-3 text-gray-800 text-center border border-b text-center block lg:table-cell relative lg:static">
        ...
        <button onClick={()=>{handleClickOpen(datas.id)}} className="text-blue-400 hover:text-blue-600 underline mr-3">
          Edit
        </button>
      ...
      <Dialog open={open} onClose={handleClose} overlayStyle={{backgroundColor: 'transparent'}}>
